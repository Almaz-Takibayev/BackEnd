@REM be-week10 launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM BE_WEEK10_config.txt found in the BE_WEEK10_HOME.
...
if "%BE_WEEK10_HOME%"=="" (
  ...
  set "BE_WEEK10_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%BE_WEEK10_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\BE_WEEK10_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running be-week10.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !BE_WEEK10_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
